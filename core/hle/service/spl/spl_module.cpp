...
void InstallInterfaces() {
    ...
    MakeService<CSRNG>(module);
    MakeService<SPL>(module);
    MakeService<SPL_MIG>(module);
    MakeService<SPL_FS>(module);
    MakeService<SPL_SSL>(module);
    MakeService<SPL_ES>(module);
    MakeService<SPL_MANU>(module);
}
