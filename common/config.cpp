...
template <>
void Config::WriteBasicSetting(Settings::BasicSetting<std::string>& setting) {
    const QString name = QString::fromStdString(setting.GetLabel());
...
template <typename Type>
void Config::WriteBasicSetting(Settings::BasicSetting<Type>& setting) {
    const QString name = QString::fromStdString(setting.GetLabel());
...
template <typename Type>
void Config::WriteGlobalSetting(Settings::Setting<Type>& setting) {
    const QString name = QString::fromStdString(setting.GetLabel());
