...
#elif (defined(__GNUC__) || defined(__llvm__)) && defined(__ARM64__)
/* Technically, if this is being compiled under __ARM64__ then it has 
...
#if (defined(__GNUC__) || defined(__llvm__)) && (defined(__i386__) || defined(__ARM64__))
