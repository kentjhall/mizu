...
public:
    explicit Maxwell3D(VideoCore::RasterizerInterface& rasterizer,
    ...
    struct Regs {
        ...
        union {
            struct {
                INSERT_PADDING_WORDS_NOINIT(0x45);
                ...
                INSERT_PADDING_WORDS_NOINIT(0x17);
                ...
                INSERT_PADDING_WORDS_NOINIT(0x41);
                ...
                INSERT_PADDING_WORDS_NOINIT(0x26);
